...
Poderíamos chamar esse parâmetro de **xix, mas por convenção chamamos de **kwargs
...
- *args;
- Parâmetros detault (não obrigatórios) - Opcionais;
- **kwargs
"""
...
# Entenda por quê é importante manter as ordens dos parâmetros na declaração
