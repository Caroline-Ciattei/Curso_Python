"""
 ...
 Dicionários são indexáveis, ou seja, não utilizamos indice.
...
print(paises.get('br'))
print(paises.get('ru')) # Caso o get não encontre o objeto com a chave informada será retornado o valor None e não será gerado KeyError.

paises = dict(br='Brasil', eua='Estados Unidos', py='Paraguai')

pais = paises.get('ru', 'Não encontrado') # Podemos definir um valor padrão para caso não encontremos o objeto com a chave informada.
...
# OBS: Tuplas por exemplo são bastante interessantes de serem utilizadas como chave de dicionários, pois as mesmas
# são imutáveis.
localidades = {
...
# CONCLUSÂO 2: Em dicionário, NÂO podemos ter chaves repetidas.
...
# OBS 1: Aqui precisamos SEMPRE informar a chave, e caso não encontre o elemento, um KeyError é retornada.
...
produto1 = {'nome': 'Play Station 4', 'quantidade': 1, 'preco': 2300.00}
...
# Copiando um diconário para outro
...
# OBS: Não podemos ter repetição de chaves em dicionários.
