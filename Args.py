...
desde que começa com asterisco.

Exemplos:

*xis

Mas por covenção, utilizamos *args para definí-lo

Mas o que é o *args?

O parâmetro *args utilizado em uma função, coloca os valores extras informados como entrada em uma tupla.
Então desde já lembre-se  que tupla são imutáveis.
...
# print(soma_todos_numeros(4, 6)) # TypeError , somente se os parâmetros não tiverem elemento declarado.
...
# Outro exemplo de utlização do *args
