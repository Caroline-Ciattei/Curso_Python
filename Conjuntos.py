...
# é ignorado sem gerar erro e não fará parte do conjunto.
...
# Listas aceitam valores duplicados (repetidos)
...
# Dicionários não aceitam chaves duplicadas, somente valores
...
# Assim como qualquer outro conjunto em Python podemos colocar tipos de dados misturados em Sets
...
# Importante lembrar que, além de não termos valores duplicados, não temos ordens
...
# OBS: Se o valor não for encontrado, não é gerado nenhum erro.
...
# Veja que alguns alunos que estudam em Pyhton também estudavam Java.
...
# Gerar um grupo de estudantes que não estão em outro curso
