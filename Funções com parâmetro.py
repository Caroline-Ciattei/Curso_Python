...
- Não possuem entrada mas posuem saída;
...
print(soma(2, 5)) # 2 e 5 são argumentos.
print(soma(10, 20))
...
# OBS: se a gente informar um número errado de parâmetro ou argumento, terenmos TypeError.
...
# Parâmetros são variáveis declarada na definição de uma função;
...
# Caso utilizemos nomes dos parâmetros para informá-los, podemos 
...
# Erro comum na utilização no return 
