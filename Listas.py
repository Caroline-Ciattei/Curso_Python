...
Linguagens C/Java: Arrays
   ...
   Ou seja, nestas linguagens se criar um array do tipo int e com tamanho 5, este array
   será SEMPRE do tipo inteiro e poderá ter SEMPRE no máximo 5 valores.

 Já em Python:

 - Dinâmico: Não possui tamanho fixo. Ou seja, podemos criar a lista e simplesmente ir adicionando elementos.( conforme a quantidade de 
...
"""
Para adicionar elementos/valores em listas, utilizamos a função append() ou expend().
- Expend não aceita valor único, exemplo: lista1.expend(45) -> Erro
OBS: Com append, só podemos adicionar 1 elemento por VEZ( Elemento único)
exemplo: lista1.append(12, 34, 56) -> Erro
"""
print(lista1)
lista1.append(42)
print(lista1)
...
#lista1.expend([123, 44, 67]) # Coloca cada elemento da lista como valor adicional á lista.
#print(lista1)
...
print(lista1)
# Podemos inverter uma lista usando a função reverse()
# Forma 1
lista1.reverse()
lista2.reverse()
print(lista1)
...
# Podemos facilmente remover o último elemento de uma lista e pode retornar o último elemento da lista
# lista2.pop()
# print(lista2)
...
# Podemos remover um elemento pelo índice(posição)
# OBS: Os elememtos á direita deste índice serão deslocados para a esquerda
...
# Outros exemplos:
# Abaixo estamos falando: Pega a lista6, coloca cifrão entre cada elemento e trasnforma em uma string

curso = '$'.join(lista6)
print(curso)

# Podemos realmente colocar qualquer tipo de dado em uma lista, inclusive misturando esses dados
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 3], 45674500]
print(lista6)
print(type(lista6))
...
# OBS: Caso não tenha este elemento na lista será apresentado erro por exemplo ValueError
...
print(numeros.index(8, 3, 6)) # Buscar o indice de 8, entre os indices 3 a 6
...
print(lista[1:]) # Iniciando no indice 1 e pegando todos os restantes
